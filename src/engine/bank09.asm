...
.ContentTable:
	db BEGINNING_POKEMON,     BEGINNING_POKEMON,     1, 2, 5,  2 ; BOOSTER_BEGINNING_POKEMON
	db LEGENDARY_POWER,       LEGENDARY_POWER,       1, 2, 5,  2 ; BOOSTER_LEGENDARY_POWER
	db ISLAND_OF_FOSSIL,      ISLAND_OF_FOSSIL,      1, 2, 5,  2 ; BOOSTER_ISLAND_OF_FOSSIL
	db PSYCHIC_BATTLE,        PSYCHIC_BATTLE,        1, 2, 6,  1 ; BOOSTER_PSYCHIC_BATTLE
	db SKY_FLYING_POKEMON,    SKY_FLYING_POKEMON,    1, 2, 6,  1 ; BOOSTER_SKY_FLYING_POKEMON
	db WE_ARE_TEAM_ROCKET,    WE_ARE_TEAM_ROCKET,    1, 2, 6,  1 ; BOOSTER_WE_ARE_TEAM_ROCKET
	db TEAM_ROCKETS_AMBITION, TEAM_ROCKETS_AMBITION, 1, 2, 6,  1 ; BOOSTER_TEAM_ROCKETS_AMBITION
