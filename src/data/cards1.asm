...
BulbasaurLv15Card:
	...
	db 0 ; damage
	db DAMAGE_NORMAL ; category
	dw BulbasaurPoisonSeedEffectCommands ; effect commands
...
IvysaurLv26Card:
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw IvysaurLeechSeedEffectCommands ; effect commands
	db NONE ; flags 1
	db HEAL_USER ; flags 2
	db NONE ; flags 3
	db 1 ; ?
...
VenusaurAltLv67Card:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw VenusaurAltEnergyTransEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
CaterpieCard:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw MayPreventRetreatingEffect ; effect commands
	db NONE ; flags 1
	db FLAG_2_BIT_6 ; flags 2
	db NONE ; flags 3
	db 1 ; ?
...
MetapodLv20Card:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw MetapodGreenShieldEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
KakunaLv20Card:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw KakunaPoisonFluidEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
ArbokLv30Card:
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw ArbokWrapEffectCommands ; effect commands
	db INFLICT_PARALYSIS ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
NidoranFLv12Card:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw NidoranFPoisonStingEffectCommands ; effect commands
	db INFLICT_POISON ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
NidorinaLv22Card:
	...
	db 10 ; damage
	db DAMAGE_PLUS ; category
	dw NidorinaStrengthInNumbersEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
NidoranMLv22Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw NidoranMFocusEnergyEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
	...
	db 40 ; damage
	db DAMAGE_NORMAL ; category
	dw NidoranMHornRushEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
NidorinoLv23Card:
	...
	db 60 ; damage
	db DAMAGE_NORMAL ; category
	dw NidorinoSwiftLungeEffectCommands ; effect commands
...
GolbatLv25Card:
	...
	db 60 ; damage
	db DAMAGE_NORMAL ; category
	dw GolbatNosediveEffectCommands ; effect commands
	db LOW_RECOIL ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
ParasectLv29Card:
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw ParasectLeechLifeEffectCommands ; effect commands
	db NONE ; flags 1
	db HEAL_USER ; flags 2
	db NONE ; flags 3
	db 3 ; ?
...
VenonatLv15Card:
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw VenonatPsybeamEffectCommands ; effect commands
	db INFLICT_CONFUSION ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
VenomothLv22Card:
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw VenomothStirUpTwisterEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
...
BellsproutLv10Card:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw BellsproutStunSporeEffectCommands ; effect commands
	db INFLICT_PARALYSIS ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
WeepinbellLv23Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw WeepinbellRegenerationEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw WeepinbellDissolveEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
WeezingLv26Card:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw WeezingPoisonMistEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
	...
	db 40 ; damage
	db DAMAGE_NORMAL ; category
	dw WeezingGasExplosionEffectCommands ; effect commands
	db LOW_RECOIL ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 30 ; ?
...
CharmanderLv9Card:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw CharmanderGatherFireEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
CharizardAltLv76Card:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw CharizardAltEnergyBurnEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
	...
	db 100 ; damage
	db DAMAGE_NORMAL ; category
	dw CharizardAltFireSpinEffectCommands ; effect commands
	db NONE ; flags 1
	db DISCARD_ENERGY ; flags 2
	db NONE ; flags 3
	db 6 ; ?
...
GrowlitheLv16Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw GrowlitheErrandRunningEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
PonytaLv8Card:
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw PonytaFireworksEffectCommands ; effect commands
	db NONE ; flags 1
	db DISCARD_ENERGY ; flags 2
	db NONE ; flags 3
	db 2 ; ?
...
RapidashLv30Card:
	...
	db 10 ; damage
	db DAMAGE_PLUS ; category
	dw RapidashFlameInfernoEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING ; flags 3
	db 0 ; ?
...
DarkRapidashCard:
	...
	db 30 ; damage
	db DAMAGE_NORMAL ; category
	dw RapidashFlamePillarEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
MagmarLv27Card:
	...
	db 10 ; damage
	db DAMAGE_PLUS ; category
	dw MagmarBurningFireEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING ; flags 3
	db 0 ; ?
	...
	; attack 2
	energy FIRE, 1, COLORLESS, 3 ; energies
...
MoltresLv37Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw MoltresDryUpEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
SquirtleLv15Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw SquirtleWaterPowerEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
WartortleLv24Card:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw WartortleBubbleEffectCommands ; effect commands
	db INFLICT_PARALYSIS ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
BlastoiseLv52Card:
	...
	db 40 ; damage
	db DAMAGE_PLUS ; category
	dw WWW40WaterGunEffectCommands ; effect commands
	db NONE ; flags 1
	db ATTACHED_ENERGY_BOOST ; flags 2
	db NONE ; flags 3
	db 2 ; ?
...
DarkBlastoiseCard:
	...
	db 30 ; damage
	db DAMAGE_PLUS ; category
	dw WW30WaterGunEffectCommands ; effect commands
	db NONE ; flags 1
	db ATTACHED_ENERGY_BOOST ; flags 2
	db NONE ; flags 3
	db 2 ; ?
...
PsyduckLv16Card:
	...
	db 20 ; damage
	db DAMAGE_PLUS ; category
	dw WC20WaterGunEffectCommands ; effect commands
	db NONE ; flags 1
	db ATTACHED_ENERGY_BOOST ; flags 2
	db NONE ; flags 3
	db 2 ; ?
...
GolduckLv28Card:
	...
	db 10 ; damage
	db DAMAGE_PLUS ; category
	dw GolduckPsychicEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
PoliwagLv13Card:
	...
	db 10 ; damage
	db DAMAGE_PLUS ; category
	dw W10WaterGunEffectCommands ; effect commands
	db NONE ; flags 1
	db ATTACHED_ENERGY_BOOST ; flags 2
	db NONE ; flags 3
	db 2 ; ?
...
PoliwagLv15Card:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw PoliwagBubbleEffectCommands ; effect commands
	db INFLICT_PARALYSIS ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
PoliwhirlLv30Card:
	...
	db 0 ; damage
	db DAMAGE_NORMAL ; category
	dw PoliwhirlTwiddleEffectCommands ; effect commands
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw PoliwagBodySlamEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
SeelLv10Card:
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw SeelIceBeamEffectCommands ; effect commands
	db INFLICT_PARALYSIS ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
DewgongLv24Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw DewgongRestEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
	...
	db 30 ; damage
	db DAMAGE_NORMAL ; category
	dw DewgongAuroraWaveEffectCommands ; effect commands
	db INFLICT_CONFUSION ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
KrabbyLv17Card:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw KrabbyBubbleEffectCommands ; effect commands
	db INFLICT_PARALYSIS ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
KinglerLv33Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw KinglerSaltWaterEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
	...
	db 80 ; damage
	db DAMAGE_NORMAL ; category
	dw PreventRetreatingToSelfEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
HorseaLv20Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw HorseaHideEffectCommands ; effect commands
	db NONE ; flags 1
	db NULLIFY_OR_WEAKEN_ATTACK ; flags 2
	db FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
SeadraLv23Card:
	...
	db 30 ; damage
	db DAMAGE_PLUS ; category
	dw WC30WaterGunEffectCommands ; effect commands
	db NONE ; flags 1
	db ATTACHED_ENERGY_BOOST ; flags 2
	db NONE ; flags 3
	db 2 ; ?
...
StaryuLv17Card:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw StaryuStrangeBeamEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
MagikarpLv6Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw MagikarpRapidEvolutionEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
MagikarpLv10Card:
	...
	db 50 ; damage
	db DAMAGE_NORMAL ; category
	dw MagikarpDragonRageEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
DarkGyaradosCard:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw FinalBeamEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
LaprasLv24Card:
	...
	db 0 ; damage
	db DAMAGE_NORMAL ; category
	dw LaprasSingEffectCommands ; effect commands
	db INFLICT_SLEEP ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
OmanyteLv22Card:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw OmanyteFossilGuidanceEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
OmastarLv36Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw OmastarTentacleGripEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
ArticunoLv34Card:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw ArticunoAuroraVeilEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
PikachuLv13Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw PikachuRechargeEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
FlyingPikachuAltLv12Card:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw FlyingPikachuAltThundershockEffectCommands ; effect commands
	db INFLICT_PARALYSIS ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
RaichuLv32Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw RaichuShortCircuitEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
MagnemiteLv12Card:
	...
	db 10 ; damage
	db DAMAGE_PLUS ; category
	dw MagnemiteMagnetismEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
MagnemiteLv15Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw MagnemiteSuperconductivityEffectCommands ; effect commands
	db DAMAGE_TO_OPPONENT_BENCH ; flags 1
	db FLAG_2_BIT_6 ; flags 2
	db FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
MagnetonLv30Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw MagnetonMicrowaveEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING | FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
VoltorbLv8Card:
	...
	db 20 ; damage
	db DAMAGE_PLUS ; category
	dw VoltorbGroupSparkEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
ZapdosLv28Card:
	...
	db 50 ; damage
	db DAMAGE_PLUS ; category
	dw ZapdosThunderCrashEffectCommands ; effect commands
	db LOW_RECOIL ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
SandshrewLv12Card:
	...
	energy COLORLESS, 2 ; energies
	tx DigName ; name
	tx SandshrewName ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db RESIDUAL ; category
	dw DigALittleEffectCommands ; effect commands
	db NONE ; flags 1
	db FLAG_2_BIT_5 ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
SandshrewLv15Card:
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw SandshrewPoisonStingEffectCommands ; effect commands
	db INFLICT_POISON ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
SandslashLv35Card:
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw SandslashSandVeilEffectCommands ; effect commands
	db NONE ; flags 1
	db NULLIFY_OR_WEAKEN_ATTACK ; flags 2
	db FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
	...
	db 40 ; damage
	db DAMAGE_PLUS ; category
	dw SandslashRollingNeedleEffectCommands ; effect commands
	db LOW_RECOIL ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0 ; ?
...
DugtrioLv40Card:
	...
	db 30 ; damage
	db DAMAGE_NORMAL ; category
	dw DugtrioEarthWaveEffectCommands ; effect commands
	db DAMAGE_TO_OPPONENT_BENCH ; flags 1
	db NONE ; flags 2
	db FLAG_3_BIT_2 ; flags 3
	db 0 ; ?
...
MankeyAltLv7Card:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw MankeyAltPeekEffectCommands ; effect commands
	db NONE ; flags 1
	db FLAG_2_BIT_5 ; flags 2
	db NONE ; flags 3
	db 0 ; ?
